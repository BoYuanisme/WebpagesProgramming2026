            ...
            <tr>
                <td width="60%" valign="top">
                    ...
                    <input type="radio" name="gender" value="female" <?php if (isset($_POST['gender']) && $_POST['gender'] == "female")
                        echo "checked"; ?>>女
                    <input type="radio" name="gender" value="secret" <?php if (isset($_POST['gender']) && $_POST['gender'] == "secret")
                        echo "checked"; ?>>不方便透露
                    ...
                    <select name="city">
                        ...
                        <option value="taipei" <?php if (isset($_POST['city']) && $_POST['city'] == "taipei")
                            echo "selected"; ?>>台北</option>
                        <option value="taoyuan" <?php if (isset($_POST['city']) && $_POST['city'] == "taoyuan")
                            echo "selected"; ?>>桃園</option>
                        <option value="hsinchu" <?php if (isset($_POST['city']) && $_POST['city'] == "hsinchu")
                            echo "selected"; ?>>新竹</option>
                        <option value="taichung" <?php if (isset($_POST['city']) && $_POST['city'] == "taichung")
                            echo "selected"; ?>>台中</option>
                        <option value="chiayi" <?php if (isset($_POST['city']) && $_POST['city'] == "chiayi")
                            echo "selected"; ?>>嘉義</option>
                        <option value="tainan" <?php if (isset($_POST['city']) && $_POST['city'] == "tainan")
                            echo "selected"; ?>>台南</option>
                        <option value="kaohsiung" <?php if (isset($_POST['city']) && $_POST['city'] == "kaohsiung")
                            echo "selected"; ?>>高雄</option>
                    </select>
                    <span class="error">* <?php echo $cityErr; ?></span>
                    <br><br>

                    想參加的營隊類型:
                    <input type="checkbox" name="type[]" value="basketball" <?php if (isset($_POST['type']) && in_array("basketball", $_POST['type']))
                        echo "checked"; ?>> 籃球
                    <input type="checkbox" name="type[]" value="baseball" <?php if (isset($_POST['type']) && in_array("baseball", $_POST['type']))
                        echo "checked"; ?>> 棒球
                    <input type="checkbox" name="type[]" value="soccer" <?php if (isset($_POST['type']) && in_array("soccer", $_POST['type']))
                        echo "checked"; ?>> 足球
                    <input type="checkbox" name="type[]" value="badminton" <?php if (isset($_POST['type']) && in_array("badminton", $_POST['type']))
                        echo "checked"; ?>> 羽球
                    <input type="checkbox" name="type[]" value="swim" <?php if (isset($_POST['type']) && in_array("swim", $_POST['type']))
                        echo "checked"; ?>> 游泳
                    <input type="checkbox" name="type[]" value="music" <?php if (isset($_POST['type']) && in_array("music", $_POST['type']))
                        echo "checked"; ?>> 音樂
                    <span class="error">* <?php echo $typeErr; ?></span>
                    <br><br>

                    同行親友陪同人數 (0~5人):
                    <input type="number" name="family_count" min="0" max="5"
                        value="<?php echo $_POST['family_count'] ?? '0'; ?>"> 人
                    <span class="error">* <?php echo $familyErr; ?></span>
                    <br><br>

                    對本次營隊的期待程度 (1~10分):
                    <input type="range" name="expectation" min="1" max="10"
                        value="<?php echo $_POST['expectation'] ?? '10'; ?>" style="accent-color: #ff8000;"
                        oninput="document.getElementById('expect_val').innerText = this.value">
                    ...
                    <button type="button"
                        onclick="var pwd = document.getElementById('myPassword'); if(pwd.type === 'password') { pwd.type = 'text'; this.innerText = '😑'; } else { pwd.type = 'password'; this.innerText = '😮'; }">😮</button>
                ...
                <td width="40%" valign="top" align="center">
                    ...
                    <table border="1" cellpadding="8" cellspacing="0" width="90%">
                        <tr bgcolor="#1266b5">
                            <th>
                                <font color="white">營隊項目</font>
                            </th>
                            <th>
                                <font color="white">基本費用</font>
                            </th>
                            <th>
